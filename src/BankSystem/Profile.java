...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 255, 204), 3, true), "Profile ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 24), new java.awt.Color(51, 255, 153))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       // String sql = "select * from Account";
        try{
            ...
            String value5 = jTextField13.getText();//Nationality
            String value1 = jTextField4.getText();//account type
            String value6 = jTextField12.getText();//Dateofbirth
            String value2 = jTextField7.getText();//gender
            String value8 = jTextField14.getText();//NID
            String value7 = jTextField6.getText();//mobile
            String value3 = jTextField9.getText();//address
            String value9 = UserIDp.getText();//userid
            
       // String sql = "update Account set Mobile = '"+value7+"' where ID = '"+value9+"'";
       
        String sql = "update Account set Name = '"+value4+"', Nationality = '"+value5+"', AType = '"+value1+"', DateofBirth = '"+value6+"',Gender = '"+value2+"', NID = '"+value8+"', Mobile = '"+value7+"', Address ='"+value3+"' where ID = '"+value9+"'";
